...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2020 at 07:39 AM
...
CREATE TABLE `tblcategory` (
  `ID` int(10) NOT NULL,
  `land_cat` varchar(120) DEFAULT NULL,
  `perch` double NOT NULL,
...
INSERT INTO `tblcategory` (`ID`, `land_cat`, `perch`, `owner`, `address`, `address2`, `broker`, `city`, `province`, `gw`, `price`, `purpose`, `sale`, `sdate`, `CreationDate`) VALUES
(50, 'Saudi Arabia', 55, 'Test User', 'Address Line 1', 'Address Line 2', 'test2', 'City', 'Central Province', 'P123', 10000, ' Testing Purpose', 'F', '0000-00-00', '2020-10-19 07:57:21'),
(51, 'Saudi Arabia', 55, 'Test User2', 'Address Line 1', 'Address Line 2', 'Test Image', 'City', 'Western Province', 'P123', 100000, ' Address Line 1', 'F', '0000-00-00', '2020-10-19 08:02:27'),
(52, 'Saudi Arabia', 100, 'Test User2', 'Address Line 1', 'Address Line 2', 'Test Image', 'City', 'Western Province', 'P12', 10000, ' Testing Purpose', 'Sold', '2020-10-23', '2020-10-19 09:39:03'),
(53, 'Test4', 5445, 'Test4 User', 'Colombo', '', 'Test 4 Broker', 'Colombo', 'Western Province', 'P124', 100000, ' Apartment', 'Sold', '2020-10-20', '2020-10-21 06:16:54');
...
CREATE TABLE `tblvehicle` (
  `ID` int(10) NOT NULL,
  `buyername` varchar(120) DEFAULT NULL,
...
INSERT INTO `tblvehicle` (`ID`, `buyername`, `buyeraddress`, `home`, `mobile`, `OwnerName`, `NIC`, `status`, `remarks`, `date`) VALUES
(20, 'test2', ' uuuhu', 2147483647, 708956458, ' Test Owner', ' 962733814V', 'Paid', 'Good', '0000-00-00'),
(21, 'test2', ' uuuhu', 2147483647, 708956458, ' Test Owner', ' 999999999', 'Not Paid', '', '0000-00-00');
