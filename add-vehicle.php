...
if (isset($_POST['submit'])) {
  ...
  $query = mysqli_query($conn, "insert into  tblvehicle(buyername,buyeraddress,home,mobile,OwnerName,NIC,status) value('$bname',' $buyeraddress','$chome',' $cmobile',' $oname',' $NIC','$pstatus')");
  if ($query) {
...
<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span> -->
                ...
                <div class="card-block">
                  <form id="main" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label" for="pstatus"  name="pstatus">Payment Status</label>
                      <div class="col-sm-4">
                        <select id="inputState" name="pstatus" id="pstatus" class="form-control">
